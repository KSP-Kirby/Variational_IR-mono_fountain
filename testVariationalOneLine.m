...
for i = 1:iterations
    ...
    [zEst_l(rowToTest,:), zEst1_1(rowToTest,:),rms(rowToTest)] = imrStereo_withGraphicsOneLine(-uv_ir{startSeq}(rowToTest,:,1), -uv_vl{startSeq}(rowToTest,:,1), zEst_l(rowToTest,:), params );
